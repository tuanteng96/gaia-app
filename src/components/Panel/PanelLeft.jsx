import { Panel, View, Page, Navbar, Block, useStore, f7, Link } from 'framework7-react'
...
export default function PanelLeft() {
    ...
    return (
        <Panel resizable left reveal swipe>
            <View>
                <Page className="bg-white page-content-hidden">
                    ...
                    <div className="h-100 d--f fd--c jc--sb">
                        ...
                        <div>
                            <div className="border-top h-45px d--f ai--c jc--c px-15px text-center" onClick={handlerLogout}>
